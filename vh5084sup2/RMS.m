...
if strcmp(plotdata.FitDisplay.haxis,'L')
        ...
        plotdata.fit.compare.y=plotdata.ScalingIntensity*plotdata.fit.y(and(plotdata.fit.x.L<max(plotdata.measure.x),plotdata.fit.x.L>min(plotdata.measure.x)));
...
elseif strcmp(plotdata.FitDisplay.haxis,'2Theta')
        ...
        plotdata.fit.compare.y=plotdata.ScalingIntensity*plotdata.fit.y(and(plotdata.fit.x.TTheta<max(plotdata.measure.x),plotdata.fit.x.TTheta>min(plotdata.measure.x)));
...
else warning('Error in plotdata.FitDisplay.haxis value (2TTheta or L)');
end; 
